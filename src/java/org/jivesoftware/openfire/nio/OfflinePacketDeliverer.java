...
/*    @Override
    ...
    public void deliver(Packet packet)
    		...
    		/*    */   {
    		/* 51 */     if ((packet instanceof Message)) {
    		/* 52 */       this.messageStrategy.storeOffline((Message)packet);
    		/*    */     }
    		/* 54 */     else if (!(packet instanceof Presence))
    		/*    */     {
    		/* 57 */       if ((packet instanceof IQ))
    		/*    */       {
    		/* 59 */         Log.warn(LocaleUtils.getLocalizedString("admin.error.routing") + "\n" + packet.toString());
    		/*    */       }
    		/*    */     }
    		/*    */   }
}
