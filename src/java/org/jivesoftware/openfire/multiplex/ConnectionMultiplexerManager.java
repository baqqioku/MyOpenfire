...
public class ConnectionMultiplexerManager implements SessionEventListener {
    ...
    public void anonymousSessionDestroyed(Session session) {
    	Log.info("anonymousSessionDestroyed------------------{},----{},----{},----{}"+session.getStatus(),session.getLastActiveDate(),session.isSecure(),session.isClosed());
    ...
    private void removeSession(Session session) {
        ...
        System.out.println("streamID------------------------:"+session.getStreamID().getID());
