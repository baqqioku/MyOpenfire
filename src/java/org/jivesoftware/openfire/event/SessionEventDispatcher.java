            ...
            try {
                switch (eventType) {
                    ...
                    case session_destroyed: {
                    	//Log.info("session close:-----getLastActiveDate:{},status:{},close:{},Secure:{},createDate:{}",session.getLastActiveDate(),session.getStatus(),session.isClosed(),session.isSecure(),session.getCreationDate());
