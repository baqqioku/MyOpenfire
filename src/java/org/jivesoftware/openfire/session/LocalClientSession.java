...
public class LocalClientSession extends LocalSession implements ClientSession {
    ...
    /*     */ 
    /*     */   public void setAnonymousAuth(String resource)
    /*     */   {
    	          //Log.info("setAnonymousAuth----------------:{}",resource);
    /* 711 */     setAddress(new JID(resource, getServerName(), resource, true));
    /* 712 */     setStatus(STATUS_AUTHENTICATED);
    /* 713 */     if (this.authToken == null) {
    /* 714 */       this.authToken = new AuthToken(resource, true);
    /*     */     }
    /* 716 */     this.sessionManager.addSession(this);
    /*     */   }
    /*     */ 
